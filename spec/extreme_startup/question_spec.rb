  ...
  describe Question do
    ...
    let(:question) { DummyQuestion.new(player) }
	 ...
	 #    end
		...
		#   player2 = Player.new
		#   10.times { DummyQuestion.new.answer = "correct" }
		#   question.answer = "correct"
		#   question.score.should == 1000
		# end

		# it "should not reduce score when player scores on other question" do
		#   10.times { DummyQuestion2.new.answer = "correct" }
		#   question.answer = "correct"
		#   question.score.should == 1000
		# end
		...
		#   10.times { DummyQuestion.new.answer = "incorrect"}
		#   question.answer = "incorrect"
		...
		#   10.times { DummyQuestion.new.answer = "incorrect" }
		#   1.times { DummyQuestion.new.answer = "correct"}
		#   question.answer = "incorrect"
